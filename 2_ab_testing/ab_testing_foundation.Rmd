...
-   success evaluation criteria tends to include a set of primary
    metric(s) + counter metrics (primary metric: revenue per user;
    counter metrics: user engagement metric)
-   measurable in the short term (ideally 1 to 2 weeks), believed to
    causally drive long term strategic metric, sensitive but not
    volatile, moveable but not easily gameable
-   when north star metric is lagging (annual subscription renewal)
    proxy metrics often used for experimentation (time to action, capped
