...
### Overview: hypothesis testing as part of AB testing (**frequentist** approach)
...
-   **Objective**
    ...
    **Test Setup**
    ...
    -   set a predefined significance level (alpha threshold; often
        0.05)

    -   if the p-value is below the alpha level, conclude a
        statistically significant difference

    -   set a practical significance threshold for business impact
    ...
    **Analyze**
    ...
    -   assess whether the result pass the practical significance
        threshold
...
### Experiment Monitoring and Early Stopping
...
-   Used as key input to power analysis
